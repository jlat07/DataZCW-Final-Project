...
data = pd.read_csv('/Users/jthompson/dev/DataZCW-Final-Project/Dashboard/date_tweets_locations_50.csv', index_col=0)

twtr_lang_df = pd.read_csv('/Users/jthompson/dev/DataZCW-Final-Project/Dashboard/twitter_lang_df.csv')
twtr_lang_df['date'] = pd.to_datetime(twtr_lang_df['date'])
